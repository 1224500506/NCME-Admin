 ...
 * 说明:
 */
public class ExamOlemAddPropAction extends BaseAction {
	...
	protected String actionExecute(ActionMapping mapping, ActionForm form,
		...
		prop.setOlem_prop_type(olemPropForm.getOlem_prop_type());
		prop.setParent_id(olemPropForm.getParent_id());
		
		
		if(olemPropForm.getOlem_prop_type()==7 || olemPropForm.getOlem_prop_type() == 10 || olemPropForm.getOlem_prop_type()==12){
			prop.setRelation(0);
			prop.setSys_prop(1);
		} else{
			prop.setRelation(1);
		...
		boolean flag = localExamOlemPropFacade.addExamOlemProp(prop);
