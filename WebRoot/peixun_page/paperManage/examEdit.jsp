...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx}/js/editExam_init.js"></script>
		...
		<ul style="margin-top:30px;">
			...
			<li style="margin-top:5px;">
				...
				<div class="fl shitin_xinzeng01" style="margin-left:100px;">
					...
					<input name="examExamination.exam_times" onkeyup="this.value= this.value.replace(/[^\d]/g, '');" class="validate[required,custom[number]] fl tki_bianji" id="examTimes" value = "${examExamination.exam_times}"/>
				</div>
				<div class="clear"></div>
			</li>
			<li style="margin-top:5px;">
				<div class="fl shitin_xinzeng01">
					...
					<p class="fl" style="width:300px;">
						<input type="radio"  name="examExamination.exam_time" value="1"
                                <c:if test = "${examExamination.exam_time eq 1}">checked</c:if> class="fl mt10 ml20"/>
						<span class="fl ml5">随时开考</span>
						<input type="radio"  <c:if test = "${examExamination.exam_time eq 2}">checked</c:if> class="fl mt10 ml30" name="examExamination.exam_time" value="2"/>
				...
				<div class="fl shitin_xinzeng01" style="margin-left:100px;">
					...
					<input type="text" class="fl tki_bianji" onkeyup="this.value= this.value.replace(/[^\d]/g, '');" style="width:63px;" size="22" name="examExamination.pass_value" id="passValue" value = "${examExamination.pass_value}"/>
			...
			<li style="margin-top:5px;">
				<div class="fl shitin_xinzeng01">
					...
					<p class="fl" style="width:300px;">
						<input type="radio" name="examExamination.paper_display_mode" <c:if test = "${examExamination.paper_display_mode eq 1}">checked</c:if> class="fl mt10 ml20" value="1" />
				...
				<div class="fl shitin_xinzeng01"  style="margin-left:100px;">
					...
					<p class="fl" style="width:300px;">
						<input type="radio" name="examExamination.question_display_mode" <c:if test = "${examExamination.question_display_mode eq 1}">checked</c:if> value="1" class="fl mt10 ml20"/>
						<span class="fl ml5">正常</span>
						<input type="radio" name="examExamination.question_display_mode" <c:if test = "${examExamination.question_display_mode eq 2}">checked</c:if> value="2" class="fl mt10" style="margin-left:58px;"/>
			...
			<li style="margin-top:5px;">
				<div class="fl shitin_xinzeng01">
					...
					<p class="fl" style="width:300px;">
						<input type="radio" name="examExamination.is_cut_screen" <c:if test = "${examExamination.is_cut_screen eq 1}">checked</c:if> value="1" title="ok" class="fl mt10 ml20"/>
			...
			<li style="margin-top:5px;">
				...
				<div class="fl shitin_xinzeng01"  style="margin-left:100px;">
					...
					<p class="fl" style="width:300px;">
						...
						<span class="fl ml5">是</span>
						<input type="radio" name="examExamination.isnot_see_result" <c:if test = "${examExamination.isnot_see_result eq 2}">checked</c:if> value="2" class="fl mt10" style="margin-left:73px;"/>
						<span class="fl ml5">否</span>
					</p>
				</div>
				<div class="clear"></div>
	...
	/*	if(result.state == "closed")
		{
			...
			str += '<p class="fl attr_xueke04" id = "chkall"><em class="fl">全部</em></p>';
			str += "</div><div class='clear'></div></li>";
		}*/
