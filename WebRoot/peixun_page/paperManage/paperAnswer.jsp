...
<%@ page import="com.hys.exam.common.util.BrowerEncodeingSwitch" %>
...
.r_siderbar_1 {
	...
	<%
		...
		String paperName = "测试试卷(答案)"+ ".doc" ;
		if(paper != null){
			paperName = paper.getName()+"(答案)"+ ".doc" ;
		}
		//paperName = new String(paperName.getBytes("gbk"), "iso-8859-1") + ".doc" ;
//		paperName = URLEncoder.encode(paperName + ".doc", "utf-8");
		response.setHeader("Content-disposition", BrowerEncodeingSwitch.getContentDisposition(paperName,request));
	%>
	<body>
