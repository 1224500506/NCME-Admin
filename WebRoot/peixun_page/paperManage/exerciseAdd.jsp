...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx}/js/addExercise_init.js"></script>
...
<div id = "tabs-1">
	...
	<div class="thi_shitineirong ca1_jichu" style="width:1040px;margin:0 auto;">		
         ...
         <!-- <input type="hidden" id="eexamType" name="examExamination.examType" value="2"/> -->		
		<ul style="margin-top:30px;">
			<li style="margin-top:20px;">
				...
				<div class="fl shitin_xinzeng01" style="margin-left:100px;">
					...
					<input type="hidden" id="examType" name="examExamination.exam_type" value = "2"/>
			...
			<li style="margin-top:5px;">
				<div class="fl shitin_xinzeng01">
					<p class="fl"><span class="fr"><i style="color:red;">*</i>练习次数：</span></p>
					<input type="text" name="examExamination.exam_num" id="examNum" onkeyup="this.value= this.value.replace(/[^\d]/g, '');"  class="fl tki_bianji"/>
				</div>
				<div class="fl shitin_xinzeng01" style="margin-left:100px;">
	...
	function putTextIn(hosIds, hosNames) {
	    ...
	    for (i = 0; i < names.length; i++) {
	   	...
	   	orgNamesInfo.push(orgNameInfo);
	        orgNamesInfo1.push(orgNameInfo);
