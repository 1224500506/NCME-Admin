...
<%@include file="/commons/taglibs.jsp"%>
	...
	<script type="text/javascript" src="${ctx}/js/jquery.form.js"></script>
	 ...
	 <script type="text/javascript" src="${ctx}/peixun_page/js/ueditor144/ueditor.config.js"></script>
	<script type="text/javascript" src="${ctx}/peixun_page/js/ueditor144/ueditor.all.min.js"></script>
	<script type="text/javascript" src="${ctx}/peixun_page/js/ueditor144/lang/zh-cn/zh-cn.js"></script>
	<style>
