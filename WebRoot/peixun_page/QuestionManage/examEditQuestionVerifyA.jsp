		...
		<ul>
			...
			<li>
				...
				<div class="fl shitin_xinzeng">
					...
					<div class="fl exp_zhuanjiak" style="width:258px;">${isUpload}			
					</div>
				</div>
					...
					<div class="fl semiOr" id="key_a">						
						...
						<c:forEach var="qk" items="${quest.questionKeyList}" varStatus="i">
							<div class="mt10 tik_danxuan">
								...
								<textarea name="answer_content" id="answer_content${i.index+1}" cols="" rows="" readonly="readonly" class="fl tki_bianji02">${qk.content}</textarea>
							</div>
							<div class="clear"></div>
						</c:forEach>
					</div>
