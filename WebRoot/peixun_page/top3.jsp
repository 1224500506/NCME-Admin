...
<%@include file="/commons/taglibs.jsp"%>
	...
	<link rel="stylesheet" href="${ctx}/peixun_page/js/ueditor143/css/ueditor.min.css" />
	...
	<script type="text/javascript" src="${ctx}/peixun_page/js/ueditor143/ueditor.config.js"></script>
	<script type="text/javascript" src="${ctx}/peixun_page/js/ueditor143/ueditor.all.min.js"></script>
	<script type="text/javascript" src="${ctx}/peixun_page/js/ueditor143/lang/zh-cn/zh-cn.js"></script>
	<style>
...
<div class="fixed" style="z-index:1000;">
	...
	<div class="lc_er">
		<div class="lc_float lc_left01"  style="display:none;">
			<a href="${ctx}/quality/userImageManage.do">人物画像</a>
			<a href="${ctx}/qualityManage/qualityManage.do?method=list">能力模型 </a>
			<a href="${ctx}/qualityManage/guide.do">学习地图</a>
		</div>
		<div class="lc_float lc_left02"  style="display:none;">
			<a href="${ctx}/CVSetManage.do?mode=myXiangMu">我的项目</a>
			<a href="${ctx}/CVSetManage.do?mode=myXueKe">我的学科</a>
			<a href="${ctx}/CVSetManage.do">项目管理 </a>
			<a href="${ctx}/CVSetQualify.do?mode=qualify">项目审核 </a>
			<a href="${ctx}/CVSet/CVDistribute.do?method=list">项目授权</a>
			<a href="${ctx}/CVSet/CVManage.do?method=list">课程管理</a>
		</div>
		<div class="lc_float lc_left03"  style="display:none;">
			<a href="${ctx}/paperManage/paperList.do">试卷管理</a>
			<a href="${ctx}/examManage/examList.do">考评管理</a>
		</div>
		<div class="lc_float lc_left04"  style="display:none;">
			<a href="${ctx}/cardManage/SystemCard.do?method=createCardList">制卡管理</a>
			<a href="${ctx}/cardManage/SystemCard.do?method=list&s=index">学习卡管理</a>
			<a href="${ctx}/cardManage/SystemCardType.do?method=list">卡类型管理</a>
			<a href="${ctx}/cardManage/SystemCard.do?method=allotList">卡类型分配管理</a>
			<a href="${ctx}/cardManage/SystemCardStatus.do?method=list">卡状态管理</a>
		</div>
		<div class="lc_float lc_left05"  style="display:none;">
			<a href="${ctx}/system/systemSite.do?method=list">站点设置</a>
			<a href="${ctx}/system/systemAdminOrgan.do?method=list">继教地区管理</a>
			<a href="${ctx}/system/systemUser.do?method=list">用户信息</a>
			<a href="${ctx}/system/SystemPostHistory.do?method=list">快递寄送管理</a>
		</div>
		<div class="lc_float lc_left06"  style="display:none;">
			<a href="${ctx}/orderManage/OrderManage.do?method=list">订单管理</a>
			
		</div>
		<div class="lc_float lc_left07"  style="display:none;">
			<a href="${ctx}/contentManage/issueManage.do?method=list">通知公告管理</a>
			<a href="${ctx}/contentManage/sentenceManage.do?method=list">文章管理</a>
			<a href="${ctx}/contentManage/editionManage.do?method=list">页面管理</a>
		</div>
		<div class="lc_float lc_left08"  style="display:none;">
			<a href="${ctx}/system/peixunOrglist.do?method=list">机构管理</a>
			<a href="${ctx}/system/systemUserStudent.do?method=list&model.userType=1">学员管理</a>
			<a href="${ctx}/system/editManage.do?method=list&model.userType=2">编辑管理</a>
			<a href="${ctx}/systemManage/getAccounts.do">账号管理</a>
			<a href="${ctx}/systemManage/RoleManage.do">角色管理</a>
			<a href="${ctx}/systemManage/getMenu.do">菜单管理</a>
		</div>
	</div>
