...
<div id="cvs_step2" style="display:none">
	...
	<div class="sub_nav">
		...
		<span class="btn_blue fr " id="step2_next"><a href="javascript:preView();" class="step2_next">下一步</a></span>
...
<div id="cvs_preView" style="display:none">
	<div class="sub_nav" style="height:40px">
		<span class="btn_blue fr" id="step2_submitAudit"><a href="javascript:cvsSubmitAudit();">提交审核</a></span>
		<span class="btn_blue fr" id=""><a href="javascript:cvsSave();">保存</a></span>
		<span class="btn_blue fr " id=""><a href="javascript:cvsSchedule();" class="step2_next">下一步</a></span>
		<span class="btn_blue fr"><a href="javascript:history.go(-1);">上一步</a></span>
	</div>
	<div id="cvs_preViewContent">
...
function preView(){
	$("#cvs_step2").hide();
	$("#cvs_preView").show();
	$("#cvs_preViewContent").load("${ctxQiantaiURL}/entityManage/entityView.do?type=play4View&paramType=project&id=${View[0].id}",function(){
		
		$(".course_video").css("float","right");
		$(".course_list").css("width","100%");
		$(".course_list").removeAttr("background-color");
		$(".course_list").css("background-color","#ededed");
		$(".iconfont").css("display","none");
		$(".course_list a").css("width","80%");
		//移除鼠标滑过显示知识点事件
		$(".container .course_right .course_list ul li").off("mouseover");
