					...
					<td width="*" valign="top">
						<div
							...
							<form class="fm1" id="fm1" name="fm1"
								action="${ctx}/system/systemSite.do?method=save"
								method="post">
									...
									<td style="width: 90%;" align="center">
										<table border=0>
											<tr>
												...
												<td>
													<input type="text" style="width: 200;"  id="id" name="model.id"
														value="${item.id}" maxlength="250" size="25" placeholder="慎重,可不填" /> 
												</td>
												<td>
											...
											<%-- <tr>
												...
												<td>
													<select style="width: 200;" id="clientId" name="model.clientId" datatype="n" errormsg="请输入所属客户！" >
											...
											<%-- <tr>
												...
												<td>
													<input type="text" style="width: 130;"   id="courseTypeHtml" disabled value="${item.courseTypeNames}" size="25"/>
													<input type="hidden"  id="courseType" name="model.courseTypeIds" value="${item.courseTypeIds}" datatype="*" errormsg="请输入课程分类！" />
													<a href="javascript:void(0)" id="getCourseTypeList" class="easyui-linkbutton" onclick="$('#dlg').dialog('open')">查找</a><span style="color:red">*</span>
												</td>
												<td>
													<div class="Validform_checktip"></div>
												</td>
											...
											<tr>	
												...
												<td>
													<select style="width: 200;" id="roleId" name="model.roleId" datatype="n" errormsg="请输入注册角色！" >
													<option value="-1">----请选择---</option>
											...
											<%-- <tr>
												...
												<td>
													<select style="width: 200;" id="applicationId" name="model.applicationId" datatype="n" errormsg="请输入所属应用！" >
													<option value="-1">----请选择---</option>
