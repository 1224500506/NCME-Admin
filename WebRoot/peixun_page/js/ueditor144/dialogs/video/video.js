...
(function(){
    ...
    window.onload = function(){
        ...
        initVideo();
        initUpload();
        //默认该标签是隐藏，页面加载后直接显示出来
        $("#uploadvideo").addClass("focus");
                ...
                switch (type) {
                    ...
                    case 'startUpload':
                        ...
                        var params = utils.serializeParam(editor.queryCommandValue('serverparam')) || '',
                            url = utils.formatUrl(actionUrl + (actionUrl.indexOf('?') == -1 ? '?':'&') + 'encode=utf-8&' + params) + "&weehoMode=insertvideo" ; //YHQ，2017-03-16;
