			...
			<li>
				<div class="mt10 shitin_xinzeng01">
					...
					<div class="fl semiOr" id="key_a">						
						...
						<c:if test="${(quest.questionKeyList)!= null && fn:length(quest.questionKeyList) == 0}">
							<div class="fl semiOr" id="key_a">
								<div class="tik_danxuan">
									<p class="fl">
										<input type="radio" value="1" name="answer_key" id="answer_key" class="fl"/>
										<em class="fl">A</em>
									</p>
									<textarea onKeyup="javascript:view_count2(this);" name="answer_content" id="answer_content1" placeholder="最大500字" cols="" rows="" class="fl tki_bianji02" maxlength="500" onpropertychange="if(value.length>500) value=value.substr(0,500)"></textarea>
								...
								<div class="mt10 tik_danxuan">
									<p class="fl">
										<input type="radio" value="2" name="answer_key" id="answer_key" class="fl"/>
										<em class="fl">B</em>
									</p>
									<textarea onKeyup="javascript:view_count2(this);" name="answer_content" id="answer_content2" placeholder="最大500字" cols="" rows="" class="fl tki_bianji02" maxlength="500" onpropertychange="if(value.length>500) value=value.substr(0,500)"></textarea>
									<span></span>
						...
						<c:forEach var="qk" items="${quest.questionKeyList}" varStatus="i">
							<div class="mt10 tik_danxuan">
								<p class="fl">
									<input type="radio" <c:if test="${qk.isnot_true eq 1}">checked</c:if> value="${i.index+1}" name="answer_key"  id="answer_key" class="fl"/>
									<em class="fl"><script type="text/javascript">document.write(String.fromCharCode(i++));</script></em>
								</p>
								<textarea placeholder="最大500字" maxlength="500" onpropertychange="if(value.length>500) value=value.substr(0,500)" onKeyup="javascript:view_count2(this);" name="answer_content" id="answer_content${i.index+1}" cols="" rows="" class="fl tki_bianji02">${qk.content}</textarea>
								<a href="javascript:dialogX('${ctxAll}/new_page/QuestionManage/adv_edit_kind.jsp',600,430,'answer_content${i.index+1}');" class="fl anniu">高级编辑</a>
								<div class="shitin_xinzeng01">
									<p class="fl" style="margin-left:40px;min-width:100px">还能输入：<span class="fr" id="spellNum" style="font-size:12px;min-width:30px">500</span></p>
									<p class="fl" style="width:0px">字</p>
								</div>
...
<script type="text/javascript">
	...
	//select menu
		...
		$('#dutyNames').click(function(){
			initPropList("职称","${ctx}/propManage/getPropListAjax.do", 24, 0, 2, 2, $('#dutyIds'), $('#dutyNames'));
			$('.att_make01').show();
		});		 
		...
		$('#content').keyup(function(){
			var zi_length = $('#content').val();
			$('#cont_zi_Number').text(500-zi_length.length);
		});
		
		$('#analyse').keyup(function(){
			var zi_length = $('#analyse').val();
			$('#analyse_zi_Number').text(500-zi_length.length);
		});
		
		$('#answer_content${i.index+1}').keyup(function(){
			var zi_length = $('#answer_content1').val();
			$('#cont_zi_Number1').text(500-zi_length.length);
...
function __addrowDX() {
	...
	if (s.length<6){	
		var str = '';
		str += '<div class="clear"></div><div class="mt10 tik_danxuan"><p class="fl"><input type="radio" value="'+ add_value +'" name="answer_key" id="answer_key" class="fl"/><em class="fl">';
