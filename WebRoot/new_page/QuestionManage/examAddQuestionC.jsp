...
<%--					<input type="hidden" name="cognize" id="cognize">	
			...
			<li>
				<div class="shitin_xinzeng01">
					...
					<textarea placeholder="最大500字" maxlength="500" onpropertychange="if(value.length>500) value=value.substr(0,500)" onKeyup="javascript:view_count(this);" onblur="checkContent(this.value)" name="content" cols="" rows="" class="fl tki_bianji01"  style="width:580px;" id="content"></textarea>
					<span></span>
			...
			<li>
				<div class="shitin_xinzeng01">
					...
					<textarea placeholder="最大500字" maxlength="500" onpropertychange="if(value.length>500) value=value.substr(0,500)" onKeyup="javascript:view_count(this);" name="answer_content" cols="" rows="" class="fl tki_bianji01"  style="width:580px;" id="answer_content"></textarea>
					<span></span>
					<div class="fl kit_gaojo">
			...
			<li>
				<div class="mt10 shitin_xinzeng01">
					...
					<textarea placeholder="最大500字" maxlength="500" onpropertychange="if(value.length>500) value=value.substr(0,500)" onKeyup="javascript:view_count(this);" name="analyse" id="analyse" cols="" rows="" class="fl tki_bianji01"></textarea>
					<span></span>
				</div>
				<div  class="shitin_xinzeng01">
					<p class="fl" style="margin-left:100px">还能输入：<span class="fr" id="spellNum" style="font-size:12px;min-width:30px">500</span></p>
...
function xaction(){
		...
		var con = $('#content').val();
		var question_content=con.getBytes();
...
function __addrowDX(n) {
	...
	if (s.length<6){	
		...
		str += '</em></p><textarea name="answer_content" onKeyup="javascript:view_count(this);"; id="answer_content';
		str += s.length + 1;
		Id = s.length + 1;
		...
		str +='\n';
		str +='<a href="javascript:dialogX(\'${ctxAll}/new_page/QuestionManage/adv_edit_kind.jsp\',600,430,\'answer_content2\');" class="fl anniu">高级编辑</a></div>';
		$('#key_a').append(str);
	}
}
