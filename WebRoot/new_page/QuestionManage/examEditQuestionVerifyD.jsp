					...
					<div class="fl semiOr" id="key_a">						
						...
						<c:forEach var="qk" items="${quest.questionKeyList}" varStatus="i">
							<div class="mt10 tik_danxuan">								
								<p class="fl">
									<input type="radio" <c:if test="${qk.isnot_true eq 1}">checked</c:if> value="1" name="answer_key" id="answer_key" class="fl"/>正确								
								</p>
								<p class="fl">
									<input type="radio" <c:if test="${qk.isnot_true eq 0}">checked</c:if> value="2" name="answer_key" id="answer_key" class="fl"/>错误 							
								</p>
