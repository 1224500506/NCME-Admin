...
--%>
			...
			<li>
				<div class="shitin_xinzeng01">
					...
					<textarea onKeyup="javascript:view_count(this);" onblur="checkContent(this.value)" name="content" cols="" rows="" class="fl tki_bianji01" placeholder="最大500字" style="width:580px;" id="content" maxlength="500" onpropertychange="if(value.length>500) value=value.substr(0,500)"></textarea>
			...
			<li>
				<div class="mt10 shitin_xinzeng01">
					...
					<textarea name="analyse" onKeyup="javascript:view_count(this);" id="analyse" placeholder="最大500字" cols="" rows="" class="fl tki_bianji01" maxlength="500" onpropertychange="if(value.length>500) value=value.substr(0,500)"></textarea>
				</div>
				<div  class="shitin_xinzeng01">
					<p class="fl" style="margin-left:100px">还能输入：<span class="fr" id="spellNum" style="font-size:12px;min-width:30px">500</span></p>
					<p class="fl" style="width:0px">字</p>
...
<script type="text/javascript">
	...
	//select menu
        ...
        function title(title){
        	if($('.tit_biaoti').text() ==title){
	             $('#xs_ul').removeClass('xs_ull');
	           }
        }
		...
		$('#laiNames').click(function(){
			...
			$('.att_make01').show();
			if($('.tit_biaoti').text() =="来源"){
             $('#xs_ul').addClass('xs_ull');
           }
		});		
