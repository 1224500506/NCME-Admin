...
--%>
			...
			<li>
				<div class="shitin_xinzeng01">
					...
					<textarea onKeyup="javascript:view_count(this);" onblur="checkContent(this.value)" name="content" cols="" rows="" class="fl tki_bianji01" placeholder="最大1800字" style="width:580px;" id="content" maxlength="1800" onpropertychange="if(value.length>1800) value=value.substr(0,1800)"></textarea>
			...
			<li>
				<div class="mt10 shitin_xinzeng01">
					...
					<textarea onKeyup="javascript:view_count3(this);" id="analyse" name = "analyse" cols="" rows="" class="fl tki_bianji01" maxlength="500" onpropertychange="if(value.length>500) value=value.substr(0,500)"></textarea>
				</div>
				<div  class="shitin_xinzeng01">
	...
	<!-- 		<li>
				<div class="mt10 shitin_xinzeng01">
					<p class="fl"><span class="fr">子试题信息：</span></p>
					<textarea name="analyse" id="analyse" cols="" rows="" class="fl tki_bianji01"></textarea>
				</div>		
		...
		<ul class="naw">
			...
			<li class="zishiti">
				<div class="mt10 shitin_xinzeng01">
					...
					<textarea onKeyup="javascript:view_count(this);" name="childContent" cols="" rows="" class="fl tki_bianji01" placeholder="最大1800字" style="width:580px;" id="content" maxlength="1800" onpropertychange="if(value.length>1800) value=value.substr(0,1800)"></textarea>
				</div>
				<div  class="shitin_xinzeng01">
					<p class="fl" style="margin-left:100px">还能输入：<span class="fr" id="spellNum" style="font-size:12px;min-width:30px">1800</span></p>
					<p class="fl" style="width:0px">字</p>
			...
			<li class="zishiti">
				...
				<div  class="shitin_xinzeng01">
					<p class="fl" style="margin-left:100px">还能入：<span class="fr" id="spellNum" style="font-size:12px;min-width:30px">500</span></p>
					<p class="fl" style="width:0px">字</p>
				</div>
				<div class="clear"></div>
