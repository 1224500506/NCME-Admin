...
<div>
	<!-- 题库内容 -->
	<div class="center">
	<h2 style="font-size:16px; font-weight:600;">设置【导航栏  &gt; 专委会】</h2>
		<div class="tk_center01" style="min-height:100px;">
			<form id="sfrm" action="${ctx}/expert/ExpertGroupManage.do?mode=editZWH" method="POST">
			<div class="tk_zuo">
	...
	<div class="tk_center01">
		...
		<div class="clear"></div>
			<display:table name="extList" requestURI="${ctx}/expert/ExpertGroupManage.do?mode=editZWH" id="p" class="mt10 cas_table" size="${totalCount}" pagesize="20" sort="list" defaultsort="0">
...
function doBatchDelProp() {
	...
	if(confirm("确认绑定吗?")){
		...
		$.post("${ctx}/expert/ExpertGroupManage.do?mode=lockEditAll", p,
  			function(data){
  				if(data != "fail"){
  					alert("所选项绑定成功!");
  				}
...
function doLock(id){
	...
	var url = '${ctx}/expert/ExpertGroupManage.do?mode=lockEdit';
	if(id!=''){
		var params = 'id=' +id;
	}
	$.ajax({
