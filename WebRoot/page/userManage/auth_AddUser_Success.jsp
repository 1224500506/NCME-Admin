						...
						<div
							style="text-align:center;border: 0px solid black; * padding-bottom: 0px; overflow: hidden;">
								...
								<c:if test="${empty exception}">
									用户添加成功！<br/><br/><a href="javascript:addUser();">继续添加</a>&nbsp;|&nbsp;<a href="javascript:findUser();">查询用户</a>
								</c:if>
								<c:if test="${!empty exception}">
									${exception}<br/><br/><a href="javascript:addUser();">重新添加</a>&nbsp;|&nbsp;<a href="javascript:findUser();">查询用户</a>
								</c:if>
								</div>
						</div>
					</td>
