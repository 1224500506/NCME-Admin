					...
					<td width="*" valign="top">
						<div
							...
							<form class="fm1" id="fm1" name="fm1"
								action="${ctx}/system/systemClient.do?method=update"
								method="post">
									...
									<td style="width: 90%;" align="center">
										<table border=0>
											<tr>
												...
												<td>
													<input type="text" id="clientName" name="model.clientName"
														value="${item.clientName}" maxlength="250" size="25"
														 datatype="s1-50" errormsg="请输入客户名称！" />
												</td>
												<td>
												...
												<td>
													<select id="orgId" name="model.orgId" datatype="n" errormsg="请输入省份！" >
												...
												<td>
													<input type="text" id="contact" name="model.contact"
														value="${item.contact}" maxlength="50" size="25"
														 datatype="s1-50" errormsg="请输入联系人！" />
												</td>
												<td>
													<div class="Validform_checktip"></div>
												</td>
