...
<table border="0" cellspacing="1" cellpadding="0" width="100%" class="gridtable">
	...
	<tr>
		<td class="row_tip">
			候选项<br><br>
			<a href="javascript:addrowDX('key_a')" >增加候选项</a><br><br>
		...
		<td colspan="5">
			<table width="100%" border="0" cellpadding="0" cellspacing="3">
				<tr>
					<td width="6%">
						<font class="red_star">*</font>A:<input type="radio" value="1" name="answer_key" id="answer_key" />
					</td>
					<td>
						<textarea name="answer_content" id="answer_content1"  style="width: 92%" rows="3" class="editTextarea"></textarea>
						<a href="javascript:dialog('adv_edit.jsp',600,430,'answer_content1');">高级编辑</a>
					</td>
				</tr>
				<tr>
					<td width="6%">
						<font class="red_star">*</font>B:<input type="radio" value="2" name="answer_key" id="answer_key" />
					</td>
					<td>
						<textarea name="answer_content" id="answer_content2" class="editTextarea" style="width: 92%" rows="3"></textarea>
