					...
					<td width="*" valign="top">
						<div
							...
							<form class="fm1" id="fm1" name="fm1" enctype="multipart/form-data"
								action="${ctx}/system/SystemNews.do?method=add"
								method="post">
						...
						<div id="main" style="width: 100%; display: block">
							<table border=0
								...
								<tr id="linkId" >
									...
									<td>
										<input type="text" name="url" id="url" class="inputa" size="30"/>
								...
								<tr>
									...
									<td>
										<input type="text" name="title" class="inputa" id="title"
								...
								<tr id="contentId4" >
									...
									<td>
										<input id="post-form:post-author" type="text" class="inputa" 
								...
								<tr id="contentId5" >
									...
									<td>
										<input id="original" type="text" id="" class="inputa" 
								...
								<tr >
								    <td>&nbsp;</td>
								    <td align="center">
								    	<input type="button" onclick="checkForm()" id="button" value="提 交" class="btn_03s">
