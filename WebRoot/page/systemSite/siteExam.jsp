...
<html>
	...
	<body>
		<div>
			...
			<div style="display:inline-block;float:left;text-align:left;height:600px;">
	...
	<script type="text/javascript">
		$('#examTree').tree({
   			onClick:function(node){
				$('#mainFrame').attr("src","${ctx}/system/siteExamList.do?siteId=${param.siteId}&courseTypeId=${param.courseTypeId}&curTypeId="+node.id);
   			},
