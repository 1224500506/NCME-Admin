...
<table border="0" cellspacing="1" cellpadding="0" width="100%" class="gridtable">
	...
	<tr>
		<td class="row_tip">
			候选项<br><br>
			<a href="javascript:addrowDuoX('key_a')" >增加候选项</a><br><br>
			<a href="javascript:deleteRowFI('key_a')" >减少候选项</a>			
		</td>
		<td colspan="5">		
			<table width="100%" border="0" cellpadding="0" cellspacing="3">
				<tr>
					<td width="6%">
						<font class="red_star"">*</font>A:<input type="checkbox" value="1" name="answer_key" id="answer_key" />
					</td>
					<td >
						<textarea name="answer_content" class="editTextarea" id="answer_content1"  style="width: 92%" rows="3"></textarea>
						<a href="javascript:dialog('adv_edit.jsp',600,430,'answer_content1');">高级编辑</a>
					</td>
				</tr>
				<tr>
					<td width="6%">
						<font class="red_star"">*</font>B:<input type="checkbox" value="2" name="answer_key" id="answer_key" />
					</td>
					<td >
						<textarea name="answer_content" class="editTextarea" id="answer_content2" style="width: 92%" rows="3"></textarea>
						<a href="javascript:dialog('adv_edit.jsp',600,430,'answer_content2');">高级编辑</a>
					</td>
				</tr>
			</table>
			<table width="100%" id="key_a" border="0" cellpadding="0" cellspacing="3"></table>			
		</td>
	</tr>
	<tr>
		<td class="row_tip">
